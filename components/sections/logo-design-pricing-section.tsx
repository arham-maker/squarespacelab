...
import {
  LOGO_DESIGN_PACKAGE_ICON,
  LOGO_DESIGN_PLANS,
  LOGO_DESIGN_PRICING_INTRO,
} from "@/lib/data/logo-design";
import { registerGsapPlugins } from "@/lib/gsap/register";

export function LogoDesignPricingSection() {
  ...
  useLayoutEffect(() => {
    ...
    const intro = section.querySelectorAll("[data-ld-pricing-intro-reveal]");
  ...
  return (
    <section
      ref={sectionRef}
      className="logo-design-pricing-section"
      id="logo-design-pricing"
      aria-label="Logo design pricing packages"
    >
      <Container>
        <div className="pricing-plans-section__intro">
          <h4
            data-ld-pricing-intro-reveal
