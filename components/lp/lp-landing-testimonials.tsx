import {
  LP_ASSETS,
  LP_SSD_LOGO,
  LP_TRUSTPILOT_EXCELLENT,
  lpImage,
} from "@/components/lp/lp-assets";
            ...
            <ul className="testimonial-wrapper">
              <li>
                ...
                <div className="testi-slide">
                  ...
                  <div className="detail-text pad-10">
                    <img
                      src={lpImage("client/ss-txt2.png")}
                      alt=""
                      loading="lazy"
                    />
                  </div>
                  <div className="client">
                    <img
                      src={LP_TRUSTPILOT_EXCELLENT}
                      alt=""
                      className="lp-trustpilot-logo"
                      loading="lazy"
                    />
                    <img
                      src={LP_SSD_LOGO}
                      alt=""
                      className="lp-ssd-logo"
                      loading="lazy"
                    />
                  </div>
                </div>
              ...
              <li>
                ...
                <div className="testi-slide">
                  ...
                  <div className="detail-text bg">
                    <img
                      src={lpImage("client/whyus-2.png")}
                      alt=""
                      loading="lazy"
                    />
                  </div>
              ...
              <li>
                ...
                <div className="testi-slide">
                  ...
                  <div className="detail-text pad-10">
                    <img
                      src={lpImage("client/ss-txt3.png")}
                      alt=""
                      loading="lazy"
                    />
                  </div>
